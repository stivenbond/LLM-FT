...
def parse_args():
    ...
    parser.add_argument("--seed-dir", default="data/seed/", help="Path to seed .txt articles")
    ...
    parser.add_argument("--output-dir", default="data/raw_synthetic/", help="Output directory")
...
def main():
    ...
    for reg in registers:
        ...
        prompt_path = Path(f"prompts/generate_synthetic_{reg}.txt")
